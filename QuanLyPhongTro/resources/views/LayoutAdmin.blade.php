            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/qly-hop-dong')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Hợp Đồng</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{URL::to('/qly-tai-khoan')}}" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Tài khoản KH</span></a></li>
